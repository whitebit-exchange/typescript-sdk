...
export type BaseClientOptions = {
    environment?: core.Supplier<environments.WhitebitApiEnvironment | environments.WhitebitApiEnvironmentUrls>;
    /** Specify a custom URL to connect the client to. */
    baseUrl?: core.Supplier<string>;
    /** Override the X-TXC-PAYLOAD header */
    txcPayload: core.Supplier<string>;
    /** Override the X-TXC-SIGNATURE header */
    txcSignature: core.Supplier<string>;
    ...
    const headers = mergeHeaders(
        {
            ...
            "X-TXC-PAYLOAD": options?.txcPayload,
            "X-TXC-SIGNATURE": options?.txcSignature,
        },
        options?.headers,
    );
